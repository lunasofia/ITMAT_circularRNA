...
foreach my $id (@ARGV) {
    ...
    `perl scripts/exonBoundaryCrossFilter.pl exon_info_docs/mm9_ucsc_exons_info.txt unnormalized_datasets/$id/100M_aln.sam > unnormalized_datasets/$id/finalMatches.sam`;
