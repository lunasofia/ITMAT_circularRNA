...
foreach my $id (@ARGV) {
    ...
    `perl scripts/exonBoundaryCrossFilter.pl -e exon_info_docs/mm9_ucsc_exons_info.txt -s unnormalized_datasets/$id/100M_aln.sam -m 30 > unnormalized_datasets/$id/finalMatches.sam`;
